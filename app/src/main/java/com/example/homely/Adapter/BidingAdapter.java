...
public class BidingAdapter extends FirebaseRecyclerAdapter<BidingData, BidingAdapter.myViewHolder> {



    public BidingAdapter(@NonNull FirebaseRecyclerOptions<BidingData> options) {
        super(options);
    }
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new BidingAdapter.myViewHolder(view);
    }
