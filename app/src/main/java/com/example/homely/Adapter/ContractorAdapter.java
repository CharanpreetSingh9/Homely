...
public class ContractorAdapter extends FirebaseRecyclerAdapter<Data, ContractorAdapter.myViewHolder> {
    /**
     ...
     * @param options
     */
    public ContractorAdapter(@NonNull FirebaseRecyclerOptions<Data> options) {
        super(options);
    }
    @Override
