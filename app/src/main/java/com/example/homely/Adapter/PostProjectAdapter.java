...
public class PostProjectAdapter extends FirebaseRecyclerAdapter<PostJobData, PostProjectAdapter.myViewHolder> {
    /**
     ...
     * @param options
     */
    public PostProjectAdapter(@NonNull FirebaseRecyclerOptions<PostJobData> options) {
        super(options);
    }
    @Override
