...
import com.example.homely.Adapter.ApplicantAppliedJobAdapter;
...
public class AppliedJob extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Biding Work");
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch(item.getItemId()){
                    case R.id.save:
                        startActivity(new Intent(getApplicationContext(), SavedWork.class));
                        overridePendingTransition(0,0);
                        return true;
                    case R.id.appled:
                        return true;
                    case R.id.home:
                        startActivity(new Intent(getApplicationContext(), ContractorDb.class));
                        overridePendingTransition(0,0);
                        return true;
                    case R.id.profile:
