...
import com.example.homely.Adapter.ReceiveAppliationAdapter;
import com.example.homely.Login;
import com.example.homely.Model.ReceiveApplicationData;
...
public class ReceiveBid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Receive Bid");
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch(item.getItemId()){
                    case R.id.home:
                        startActivity(new Intent(getApplicationContext(), UserDb.class));
